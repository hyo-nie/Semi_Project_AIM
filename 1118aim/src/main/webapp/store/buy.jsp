      ...
      IMP.request_pay({ 
          ...
          if (rsp.success) {
             console.log("결제 성공!");
              ...
              location.href="./OrderAddAction.or";
              
          } else {
        	  console.log(rsp)
              console.log("결제 실패!");
        	  alert('결제 실패!');
        	  // 결제 실패 시 이동하는 페이지(./CartList.ct)
	...
	<div id="contents" class="gift_store">
		...
		<div class="com_cart_list_wrap com_cart_list_wrap1">
			...
			<table class="com_cart_total_price_wrap">
				...
				<%-- <c:set var="totalPrice" />
				<c:forEach var="i" begin="0" end="${cartList.size()-1}" step="1" >
					${totalPrice += cartList[i].c_amount * productList[i].st_price }
				</c:forEach> --%>
			  ...
			  <div class="accordion-item">
			    ...
			    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
			      <div class="accordion-body">
					...
					1. CJ올리브네트웍스㈜(이하 '회사')는 이용자의 개인정보를 본 개인정보처리방침에서 고지한 범위 내에서 사용하며, 이용자의 사전 동의 없이 동 범위를 초과하여 이용하거나 이용자의 개인 정보를 제3자에게 제공하지 않습니다. 다만, 아래의 경우에는 예외로 합니다.
					<br>
					· 이용자가 사전에 동의한 경우<br>
					...
					-제공받는 자
					<br>
					· 신용카드 등록 및 결제서비스: NICE정보통신
					· 계좌 등록 및 계좌이체 결제서비스: ㈜헥토파이낸셜
					-제공 정보
					<br>
					· 신용카드 등록 및 결제서비스: 카드사명, 결제정보(카드번호, 카드비밀번호 앞2자리, 카드유효기간, CVC(카드사별 상이), CI, 휴대전화번호, 생년월일, 성별, 내/외국인여부, 상품명, 이용자ID 등)
					<br>
					· 계좌 등록 및 계좌이체 결제서비스: 금융기관명, 계좌번호, 계좌주, 생년월일, 휴대폰전화번호, CI, 이용자ID 등
					<br>
					- 보유 및 이용기간
					<br>
					· 개인정보는 원칙적으로 개인 정보의 수집 및 이용목적이 달성되면 지체 없이 파기합니다
					...
					· 페이코: NHN페이코㈜<br>
					· 페이나우: 토스페이먼츠<br>
					· 스마일페이: LG CNS, ㈜이베이코리아<br>
					· 네이버페이: 네이버파이낸셜㈜<br>
					· 슈가페이: NICE정보통신, ㈜헥토파이낸셜<br>
					· 토스: ㈜비바리퍼블리카<br>
					· 내통장: ㈜헥토파이낸셜<br>
					· 차이: ㈜차이코퍼레이션<br>
					· 페이코인: ㈜다날<br>
					...
					· 결제정보 (전화번호, 상품명 등) (슈가페이: CI, 이용자ID/폰페이: CI,휴대전화번호 포함)
					<br>
					- 보유 및 이용기간
					<br>
					· 개인정보는 원칙적으로 개인 정보의 수집 및 이용목적이 달성되면 지체 없이 파기합니다
					...
					- 제공받는 자
					<br>
					· 은행: 기업, 국민, KEB하나, 수협, 농협, 우리, SC제일, 씨티, 대구, 부산, 광주, 제주, 전북, 경남, 새마을금고, 신협, 우체국, 신한, 산림조합, 산업<br>
					· 증권: 유안타, 현대, 미래에셋, 한투, 우리투자, 하이투자, HMC투자, SK, 대신, 하나대투, 신한금융, 동부, 유진투자, 메리츠, 신영, 삼성, 한화, 대우<br>
					· 금융결제원, 토스페이먼츠<br>
					· CMS 계좌이체: 효성에프엠에스<br>
					- 제공 정보
					<br>
					· 결제정보(계좌번호, 고객명,생년월일 등)
					<br>
					-보유 및 이용기간
					<br>
					· 개인정보는 원칙적으로 개인 정보의 수집 및 이용목적이 달성되면 지체 없이 파기합니다
					...
					- 제공받는 자
					<br>
					· 은행: 기업, 국민, KEB하나, 수협, 농협, 우리, SC제일, 신한, 부산, 광주, 우체국<br>
					· 토스페이먼츠, ㈜헥토파이낸셜<br>
					- 제공 정보
					<br>
					· 결제정보(가상 계좌번호 등)
					...
					-제공받는 자
					<br>
					· 이동통신사: (주)SKT, ㈜KT, ㈜LGU+, MVNO사업자<br>
					· ㈜모빌리언스, 갤럭시아머니트리㈜, ㈜다날, (주)NHN한국사이버결제<br>
					-제공 정보<br>
					
					· 결제정보(휴대폰 번호, 생년월일, 성별 등)
					<br>
					-보유 및 이용기간
					<br>
					· 개인정보는 원칙적으로 개인 정보의 수집 및 이용목적이 달성되면 지체 없이 파기합니다
