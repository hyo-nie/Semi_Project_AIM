...
<script type="text/javascript"
	src="https://tag-deepad.lpoint.com/cookie?mid=4&amp;cid=1154777567.1667836528"></script>
<script type="text/javascript"
	src="https://www.google-analytics.com/analytics.js"></script>
<script type="text/javascript"
	src="https://www.google-analytics.com/analytics.js"></script>
<script type="text/javascript"
	src="https://www.googletagmanager.com/gtag/js?id=UA-164790289-1&amp;l=dataLayer&amp;cx=c"></script>
<script src="//dsp.dmcmedia.co.kr/selper/js/selperevt.js?ver=0.1.4.1"></script>
<script
	src="https://connect.facebook.net/signals/config/233523444404890?v=2.9.89&amp;r=stable"></script>
...
<body>
	...
	<div id="header_section" class="header ty3">
		...
		<div id="nav" class="area__gnbmovingbar">
			<ul>
				...
				<li class=""><a href="./StoreMain.st">스토어</a> <!-- 스토어 임시 가상주소 입니다 자유롭게 변경해서 사용해주세요 -->
					<div>
						<ul>
	...
	<div id="contents" class="contents_full contents_member_comn" style="">
		...
		<script
			src="/NLCHS/Scripts/common/crossDomainStorage.js?v=202211080103"></script>
