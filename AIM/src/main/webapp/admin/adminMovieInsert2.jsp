...
<!-- 내용시작	 -->
		...
		<br><br>
	<div align="center">
		<input type="button" value="모두 저장" onclick="movieCdCheck();" style="color:#fff; background:#18315D; width:75px; height:25px; margin:5px; border-radius:5px; border:1px solid #fff;"> 
